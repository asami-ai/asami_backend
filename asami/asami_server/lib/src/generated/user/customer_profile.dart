...
class CustomerProfileTable extends _i1.Table<_i1.UuidValue> {
  CustomerProfileTable({super.tableRelation})
    ...
    savedAddresses = _i1.ColumnSerializable(
      'savedAddresses',
      this,
    );
    favoriteVendors = _i1.ColumnSerializable(
      'favoriteVendors',
      this,
    );
    ...
    searchHistory = _i1.ColumnSerializable(
      'searchHistory',
      this,
    );
    viewedProducts = _i1.ColumnSerializable(
      'viewedProducts',
      this,
    );
    preferredCategories = _i1.ColumnSerializable(
      'preferredCategories',
      this,
    );
  ...
  late final _i1.ColumnSerializable savedAddresses;

  late final _i1.ColumnSerializable favoriteVendors;
  ...
  late final _i1.ColumnSerializable searchHistory;

  late final _i1.ColumnSerializable viewedProducts;

  late final _i1.ColumnSerializable preferredCategories;
