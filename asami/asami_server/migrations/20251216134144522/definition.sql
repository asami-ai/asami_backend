...
CREATE TABLE "orders" (
    ...
    "paymentStatus" bigint NOT NULL DEFAULT 0,
...
CREATE TABLE "products" (
    ...
    "condition" bigint NOT NULL DEFAULT 0,
...
CREATE TABLE "vendor_profiles" (
    ...
    "subscriptionTier" bigint NOT NULL DEFAULT 0,
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('asami', '20251216134144522', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251216134144522', "timestamp" = now();
