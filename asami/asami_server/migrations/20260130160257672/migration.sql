...
CREATE TABLE "order_escrows" (
    ...
    "paystackFee" double precision NOT NULL,
    "status" text NOT NULL,
    "expectedDeliveryDate" timestamp without time zone,
    "deliveryDeadline" timestamp without time zone NOT NULL,
    "markedDeliveredAt" timestamp without time zone,
    "customerAcknowledgedAt" timestamp without time zone,
    "returnWindowStart" timestamp without time zone,
    "returnWindowEnd" timestamp without time zone,
    "isReturnWindowActive" boolean NOT NULL DEFAULT false,
    "isReturnWindowExpired" boolean NOT NULL DEFAULT false,
    "canRelease" boolean NOT NULL DEFAULT false,
    "releaseScheduledAt" timestamp without time zone,
    ...
    "refundProcessedAt" timestamp without time zone,
    "isAutoReleased" boolean NOT NULL DEFAULT false,
    "isManuallyReleased" boolean NOT NULL DEFAULT false,
...
-- Indexes
CREATE INDEX "escrow_order_idx" ON "order_escrows" USING btree ("orderId");
CREATE INDEX "escrow_vendor_idx" ON "order_escrows" USING btree ("vendorId");
CREATE INDEX "escrow_status_idx" ON "order_escrows" USING btree ("status");
CREATE INDEX "release_schedule_idx" ON "order_escrows" USING btree ("releaseScheduledAt", "canRelease");
CREATE INDEX "return_window_idx" ON "order_escrows" USING btree ("isReturnWindowActive", "returnWindowEnd");
...
CREATE TABLE "payment_transactions" (
    ...
    "gateway" text NOT NULL DEFAULT 'paystack'::text,
    ...
    "paystackFee" double precision NOT NULL DEFAULT 0.0,
    "platformFee" double precision NOT NULL DEFAULT 0.0,
...
-- Indexes
CREATE INDEX "reference_idx" ON "payment_transactions" USING btree ("reference");
CREATE INDEX "user_status_idx" ON "payment_transactions" USING btree ("userId", "status");
CREATE INDEX "the_order_idx" ON "payment_transactions" USING btree ("orderId");
CREATE INDEX "payment_status_idx" ON "payment_transactions" USING btree ("status");
CREATE INDEX "expired_idx" ON "payment_transactions" USING btree ("isExpired", "expiresAt");
CREATE INDEX "createdat_idx" ON "payment_transactions" USING btree ("createdAt");
...
CREATE TABLE "vendor_wallets" (
    ...
    "processingBalance" double precision NOT NULL DEFAULT 0.0,
    ...
    "recipientCode" text,
    "recipientId" text,
    "isRecipientActive" boolean NOT NULL DEFAULT false,
    "minimumWithdrawal" double precision NOT NULL DEFAULT 1000.0,
    "autoWithdrawal" boolean NOT NULL DEFAULT false,
    "autoWithdrawalThreshold" double precision,
    "totalTransactions" bigint NOT NULL DEFAULT 0,
    "successfulWithdrawals" bigint NOT NULL DEFAULT 0,
    "failedWithdrawals" bigint NOT NULL DEFAULT 0,
    "isActive" boolean NOT NULL DEFAULT true,
    "isSuspended" boolean NOT NULL DEFAULT false,
    "suspensionReason" text,
    "lastWithdrawalAt" timestamp without time zone,
    "lastEarningAt" timestamp without time zone,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);

-- Indexes
CREATE INDEX "wallet_vendor_idx" ON "vendor_wallets" USING btree ("vendorId");
...
CREATE TABLE "wallet_transactions" (
    ...
    "notes" text,
    "status" text NOT NULL DEFAULT 'pending'::text,
    "isInEscrow" boolean NOT NULL DEFAULT false,
    "escrowReleasedAt" timestamp without time zone,
    "escrowReleaseScheduledAt" timestamp without time zone,
    "transferCode" text,
    "transferId" text,
    "transferStatus" text,
...
-- Indexes
CREATE INDEX "wallet_idx" ON "wallet_transactions" USING btree ("walletId");
CREATE INDEX "vendor_wallet_idx" ON "wallet_transactions" USING btree ("vendorId");
CREATE INDEX "wallet_type_idx" ON "wallet_transactions" USING btree ("type");
CREATE INDEX "wallet_status_idx" ON "wallet_transactions" USING btree ("status");
CREATE INDEX "wallet_escrow_idx" ON "wallet_transactions" USING btree ("isInEscrow", "escrowReleaseScheduledAt");
CREATE INDEX "wallet_reference_idx" ON "wallet_transactions" USING btree ("referenceType", "referenceId");
...
CREATE TABLE "webhook_events" (
    ...
    "isVerified" boolean NOT NULL DEFAULT false,
    "verifiedAt" timestamp without time zone,
    "source" text NOT NULL DEFAULT 'paystack'::text,
    "ipAddress" text,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
-- Indexes
CREATE INDEX "vendor_withdrawal_idx" ON "withdrawal_requests" USING btree ("vendorId");
CREATE INDEX "wallet_withdrawal_idx" ON "withdrawal_requests" USING btree ("walletId");
CREATE INDEX "withdrawal_status_idx" ON "withdrawal_requests" USING btree ("status");
CREATE INDEX "request_number_idx" ON "withdrawal_requests" USING btree ("requestNumber");
...
ALTER TABLE ONLY "wallet_transactions"
    ...
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "wallet_transactions"
    ADD CONSTRAINT "wallet_transactions_fk_1"
    FOREIGN KEY("orderId")
    REFERENCES "orders"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
ALTER TABLE ONLY "withdrawal_requests"
    ...
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "withdrawal_requests"
    ADD CONSTRAINT "withdrawal_requests_fk_1"
    FOREIGN KEY("walletId")
    REFERENCES "vendor_wallets"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('asami', '20260130160257672', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260130160257672', "timestamp" = now();
